...
To show current user:
    ...
    $ who am i
    mshaq     pts/0        2016-08-22 10:26 (192.168.56.1)

`$ grep mshaq /etc/passwd`

    mshaq:x:1000:1000:Siva:/home/mshaq:/bin/bash
...
`$ id`
    ...
    uid=1000(mshaq) gid=1000(mshaq) groups=1000(mshaq),10(wheel) context=unconfined_u:unconfined_r:unconfined_t:s0-s0:c0.c1023

See which users logged into the system currently

    $ who -uH
    NAME     LINE         TIME             IDLE          PID COMMENT
    mshaq     :0           2016-08-22 10:11   ?          2575 (:0)
    mshaq     tty2         2016-08-22 10:12 00:29        3443
    mshaq     pts/0        2016-08-22 10:26   .          3935 (192.168.56.1)
...
2. On client machine, generate ssh keys
  ...
  ssh-copy-id mshaq@192.168.0.103

  Now you can ssh without requiring to enter password:
  ssh mshaq@192.168.0.103
