...
Build an image using Dockerfile: `docker build -t mshaq/myapp:1.0 .`
...
LABEL maintainer="mshaq@mail.com"
...
```
FROM busybox:latest
MAINTAINER mshaq <mshaq.k@gmail.com>
...
* `docker push mshaq/myapp`

Delete Image

* `docker rmi mshaq/myapp`
